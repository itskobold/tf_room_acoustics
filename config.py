...
DIM_LENGTHS = 1., 1., 0.005  # X, Y, T domain lengths in meters (X, Y) and seconds (T)
...
FDTD_NUM_BC_ABSORPTION_COEFFS = 80  # Number of random sets of BC absorption coeffs to generate
...
NN_HIDDEN_LAYERS = 4
NN_HL_WIDTH = 20
NN_ITERATIONS_ADAM = 250
NN_ITERATIONS_L_BFGS_B = 500
NN_BATCH_SIZE = 128
