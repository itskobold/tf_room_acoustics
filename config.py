...
FDTD_NUM_MESHES_TRAIN = 100  # Number of meshes to generate for training data
FDTD_NUM_MESHES_TEST = 5  # Number of meshes to generate for test data
...
NN_OUTPUT_T_LEN = 1  # Time length in samples of prediction volume. Must be evenly divisible by FNO_T_LOOKBACK
NN_HL_WIDTH = 128  # Width of final up projection dense layer
NN_BIG_BATCH_SIZE = 128  # Size of chunks passed to network from blocks
NN_BATCH_SIZE = 64  # Size of batches processed by the network
...
ANIM_MAX_FRAMES = 999999999999999999999999999999999#200  # Maximum number of frames to animate
